...
| `docs/the-missing-texture-board.md` | the layer-3 board: staged-never-deployed rescue, mask rescue, `metalic_e` cubemap chain of custody, phase-4 mesh-side case war, phase-5 vanilla-master front (crash fix), sealed-gap families |
